...
class DrugDataset(utils.Dataset):
    ...
    #####                                     #####
        ...
        self.add_class("bread", 1, "polo") # 黑色素瘤
        self.add_class("bread", 2, "Red_bean")
    ...
    ############################################### 
        ...
        for i in range(count):
            ...
            self.add_image("bread", image_id=i, path=img_floder + "/" + imglist[i],
    ...
    #####                                     #####        
        ...
        for i in range(len(labels)):
            if labels[i].find("polo") != -1:
                # print "box"
                labels_form.append("polo")
            elif labels[i].find("Red_bean")!=-1:
                #print "column"
                labels_form.append("Red_bean")
